...
public class DBRouterJoinPoint {
    ...
    @Pointcut("@annotation(com.yamon.middleware.db.router.annotation.DBRouter)")
     ...
     *
     * JoinPoint用于获取方法的信息，而ProceedingJoinPoint除了能获取方法的信息外，还可以控制方法的执行
